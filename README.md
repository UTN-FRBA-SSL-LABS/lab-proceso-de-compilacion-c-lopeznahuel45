...
> **R:**
Es mucho mayor a 94 porque en el archivo.i se trae el codigo de las directivas del principio del archivo.c, se trae todas esas funciones.
---
...
> **R:**
No encuentra nada porque el archivo.i ya no tiene comentarios porque fue limpiado en la etapa de preprocesamiento
---
...
> **R:**
Indican el nro de linea original de donde proviene el codigo. Proviene del archivo stdio.h
---
...
> **R:**
push guarda en la pila el puntero para no perderlo.
movl mueve un dato.
addl suma un valor a otro.
...
> **R:**
tiene T en matematica.o porque es acá donde se define
...
> **R:**
quedan porque son funciones de la biblioteca del sistema. Se resuelven en tiempo de ejecucion por el enlazador.
...
> **R:**
Una macro funcion es un reemplazo, en el preprocesamiento se reemplaza, por ej: CUADRADO(x), por su definicion, desaparece en esta misma etapa. Una funcion real es codigo definido formalmente con parametros, la cual se compila y se ejecuta cuando la llaman, "desaparece" en tiempo de ejecucion. Una funcion real tiene verificacion de tipos.
...
> **R:**
Un simbolo de tipo T es codigo ejecutado, los tipo D son variables globales. Los tipo T viven en la seccion T, los tipo D en data 
